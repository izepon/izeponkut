...
// Menu
// ================================================================================================================
export function IzeponKutMenu({ githubUser }) {
  const [isMenuOpen, setMenuState] = React.useState(false);
  return (
    <IzeponKutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <IzeponKutMenu.Logo src={`https://www.datocms-assets.com/52064/1627064611-svg-izeponkut-title.svg`} />
        ...
        <nav>
          ...
          <div>
            <input placeholder="Pesquisar no Izeponkut" />
          </div>
        </nav>
      ...
      <IzeponkutMenuProfileSidebar githubUser={githubUser} />
    </IzeponKutMenu.Wrapper>
  )
}
IzeponKutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;
  .izeponkutMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
function IzeponkutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="izeponkutMenuProfileSidebar">
      <div>
...
// IzeponkutProfileSidebarMenuDefault
// ================================================================================================================
export function IzeponkutProfileSidebarMenuDefault() {
  return (
    <IzeponkutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
IzeponkutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
...
// Login Page
// ================================================================================================================
const IzeponkutLoginScreen = css`
  :root {
...
// Reset Styles
// ================================================================================================================
export const IzeponkutStyles = css`
  *::-webkit-scrollbar {
    width: 8px;
  }
